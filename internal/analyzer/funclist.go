...
import "fillmore-labs.com/zerolint/internal/typeutil"
...
var functions = map[typeutil.FuncName]funcType{ //nolint:gochecknoglobals
	...
	{Path: "github.com/stretchr/testify/assert", Receiver: "Assertions", Name: "ErrorIs"}:      funcCmp0,
	{Path: "github.com/stretchr/testify/assert", Receiver: "Assertions", Name: "ErrorIsf"}:     funcCmp0,
	{Path: "github.com/stretchr/testify/assert", Receiver: "Assertions", Name: "NotErrorIs"}:   funcCmp0,
	{Path: "github.com/stretchr/testify/assert", Receiver: "Assertions", Name: "NotErrorIsf"}:  funcCmp0,
	{Path: "github.com/stretchr/testify/require", Receiver: "Assertions", Name: "ErrorIs"}:     funcCmp0,
	{Path: "github.com/stretchr/testify/require", Receiver: "Assertions", Name: "ErrorIsf"}:    funcCmp0,
	{Path: "github.com/stretchr/testify/require", Receiver: "Assertions", Name: "NotErrorIs"}:  funcCmp0,
	{Path: "github.com/stretchr/testify/require", Receiver: "Assertions", Name: "NotErrorIsf"}: funcCmp0,
	...
	{Path: "github.com/stretchr/testify/assert", Receiver: "Assertions", Name: "ErrorAs"}:      funcDecode,
	{Path: "github.com/stretchr/testify/assert", Receiver: "Assertions", Name: "ErrorAsf"}:     funcDecode,
	{Path: "github.com/stretchr/testify/assert", Receiver: "Assertions", Name: "NotErrorAs"}:   funcDecode,
	{Path: "github.com/stretchr/testify/assert", Receiver: "Assertions", Name: "NotErrorAsf"}:  funcDecode,
	{Path: "github.com/stretchr/testify/require", Receiver: "Assertions", Name: "ErrorAs"}:     funcDecode,
	{Path: "github.com/stretchr/testify/require", Receiver: "Assertions", Name: "ErrorAsf"}:    funcDecode,
	{Path: "github.com/stretchr/testify/require", Receiver: "Assertions", Name: "NotErrorAs"}:  funcDecode,
	{Path: "github.com/stretchr/testify/require", Receiver: "Assertions", Name: "NotErrorAsf"}: funcDecode,
	{Path: "encoding/json", Name: "Unmarshal"}:                                                 funcDecode,
	{Path: "encoding/json", Receiver: "Decoder", Name: "Decode"}:                               funcDecode,
	{Path: "github.com/goccy/go-yaml", Name: "Unmarshal"}:                                      funcDecode,
	{Path: "github.com/goccy/go-yaml", Name: "UnmarshalContext"}:                               funcDecode,
	{Path: "github.com/goccy/go-yaml", Name: "UnmarshalWithOptions"}:                           funcDecode,
	{Path: "github.com/goccy/go-yaml", Receiver: "Decoder", Name: "Decode"}:                    funcDecode,
	{Path: "github.com/goccy/go-yaml", Receiver: "Decoder", Name: "DecodeContext"}:             funcDecode,
	{Path: "github.com/goccy/go-yaml", Receiver: "Decoder", Name: "DecodeFromNode"}:            funcDecode,
	{Path: "github.com/goccy/go-yaml", Receiver: "Decoder", Name: "DecodeFromNodeContext"}:     funcDecode,
	{Path: "github.com/ghodss/yaml", Name: "Unmarshal"}:                                        funcDecode,
	{Path: "github.com/go-yaml/yaml", Name: "Unmarshal"}:                                       funcDecode,
	{Path: "github.com/go-yaml/yaml", Name: "UnmarshalStrict"}:                                 funcDecode,
	{Path: "github.com/go-yaml/yaml", Receiver: "Decoder", Name: "Decode"}:                     funcDecode,
	{Path: "gopkg.in/yaml.v2", Name: "Unmarshal"}:                                              funcDecode,
	{Path: "gopkg.in/yaml.v2", Name: "UnmarshalStrict"}:                                        funcDecode,
	{Path: "gopkg.in/yaml.v2", Receiver: "Decoder", Name: "Decode"}:                            funcDecode,
