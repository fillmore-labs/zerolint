...
const (
	Name = "zerolint"
	Doc  = `zerolint checks for usage of pointers to zero-size types (e.g., *struct{}, *[0]byte).
...
- The pointers themselves are not zero-sized and might waste memory in structures, on the stack and of the CPU cache.

This analyzer helps identify such patterns to encourage using ZSTs by value or finding alternative designs.`
)
