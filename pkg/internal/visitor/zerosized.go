...
func (v *visitorInternal) zeroSizedTypePointer(t types.Type) (types.Type, bool) {
...
func (v *visitorInternal) zeroSizedType(t types.Type) bool {
	if !zeroSized(t) {
		return false
	}

	// Check if declared in a generated file or exclude by comment
