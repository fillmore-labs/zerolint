...
func (v *visitorInternal) visitCallFun(n *ast.CallExpr) bool {
...
func (v *visitorInternal) visitCallSelector(n *ast.CallExpr, fun *ast.SelectorExpr) bool {
...
func (v *visitorInternal) visitCallSelection(fun *ast.SelectorExpr, sel *types.Selection) bool {
...
func (v *visitorInternal) visitCallIdent(n *ast.CallExpr, fun *ast.Ident) bool {
...
func (v *visitorInternal) visitCallQualifiedIdent(n *ast.CallExpr, path, name string) bool {
	switch {
...
func (v *visitorInternal) visitCast(n *ast.CallExpr, t types.Type) bool {
	if len(n.Args) != 1 {
		return true
	}
